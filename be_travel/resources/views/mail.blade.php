{{-- email dang ky tai khoan khach hang --}}
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="vi">
 <head>
  ...
  <title>Kích hoạt tài khoản du lịch</title><style type="text/css">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:10px">
                       <div style="font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:15px; color:#333333; line-height: 1.6;">
                        Chào bạn, <b>{{$data['ho_va_ten']}}</b>,<br><br>
                        Cảm ơn bạn đã tin tưởng và đăng ký tài khoản tại hệ thống đặt tour của chúng tôi với email <b>{{$data['email']}}</b>. Để hoàn tất thủ tục đăng ký và bắt đầu khám phá những chuyến đi tuyệt vời, vui lòng nhập mã bên dưới:
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;border-radius:5px;border-collapse:separate" role="presentation">
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                        ...
                        Nếu bạn không tạo tài khoản này, vui lòng bỏ qua email để đảm bảo an toàn thông tin.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
