            ...
            <div class="noi-dung-the">
              ...
              <form @submit.prevent="xacNhan" class="bieu-mau-xac-nhan">
                <div class="nhom-nhap-lieu mb-4 text-center">
                  <label class="form-label text-secondary fw-bold small mb-2">Nhập Mã Xác Nhận</label>
                ...
                <div class="d-flex flex-column gap-3 mt-2 pt-2 border-top">
                  <button type="submit" class="nut-chinh w-100 d-flex justify-content-center align-items-center gap-2 mt-3" :disabled="isLoading">
...
export default {
    ...
    mounted() {
        if (!this.email) {
            ...
            this.$router.push('/huong-dan-vien/dang-ky');
        }
    },
    methods: {
        xacNhan() {
            ...
            axios.post(apiUrl('huong-dan-vien/xac-nhan-dang-ky'), payload)
                .then((response) => {
